...
def test_str5():
    ...
    introcs.assert_equals('130.6',  a3final.str5(130.59))
    introcs.assert_equals('130.5',  a3final.str5(130.54))
    introcs.assert_equals('100.0',  a3final.str5(100))
    introcs.assert_equals('100.6',  a3final.str5(100.56))
    introcs.assert_equals('99.57',  a3final.str5(99.566))
    introcs.assert_equals('99.99',  a3final.str5(99.99))
    introcs.assert_equals('100.0',  a3final.str5(99.995))
    introcs.assert_equals('22.00',  a3final.str5(21.99575))
    introcs.assert_equals('21.99',  a3final.str5(21.994))
    introcs.assert_equals('10.01',  a3final.str5(10.013567))
    introcs.assert_equals('10.00',  a3final.str5(10.000000005))
    introcs.assert_equals('10.00',  a3final.str5(9.9999))
    introcs.assert_equals('9.999',  a3final.str5(9.9993))
    introcs.assert_equals('1.355',  a3final.str5(1.3546))
    introcs.assert_equals('1.354',  a3final.str5(1.3544))
    introcs.assert_equals('0.046',  a3final.str5(.0456))
    introcs.assert_equals('0.045',  a3final.str5(.0453))
    introcs.assert_equals('0.006',  a3final.str5(.0056))
    introcs.assert_equals('0.001',  a3final.str5(.0013))
    introcs.assert_equals('0.000',  a3final.str5(.0004))
    introcs.assert_equals('0.001',  a3final.str5(.0009999))
...
def test_str5_color():
    ...
    text = a3final.str5_cmyk(introcs.CMYK(98.448, 25.362, 72.8, 1.0))
    introcs.assert_equals('(98.45, 25.36, 72.80, 1.000)',text)

    text = a3final.str5_cmyk(introcs.CMYK(0.0, 1.5273, 100.0, 57.846))
    introcs.assert_equals('(0.000, 1.527, 100.0, 57.85)',text)

    # Tests for str5_hsv (add two)
    text = a3final.str5_hsv(introcs.HSV(98.448, 0.123456789, 0.0))
    introcs.assert_equals('(98.45, 0.123, 0.000)',text)

    text = a3final.str5_hsv(introcs.HSV(0.0,0.313725490196,1.0))
    introcs.assert_equals('(0.000, 0.314, 1.000)',text)
    #test max value for H
    text = a3final.str5_hsv(introcs.HSV(359.99,1.0,1.0))
    introcs.assert_equals('(360.0, 1.000, 1.000)',text)
    #test min values
    text = a3final.str5_hsv(introcs.HSV(0.0,0.0,0.0))
...
def test_contrast_rgb():
    ...
    hsv = a3final.contrast_rgb(rgb,-0.4)
